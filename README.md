(From https://github.com/andrewdcampbell/movie-barcodes , I just made it so it auto detects input width and height, also added a function for batch barcoding youtube videos, needs youtube-dl for depend. Also added a param for calculating a width factor based on video width.)
